...
pin: false
image:
  path: /images/2025-11-28-header-go-train.png
  alt: GO Train
---
...
Metrolinx purchased the Union Station Rail Corridor [in 2000](https://web.archive.org/web/20071023065317/http://www.ttrly.com/history.htm), and the Weston Subdivision [in 2008](https://stevemunro.ca/2009/04/08/go-transit-buys-cn-weston-subdivision/%20), upgrading to higher quality track, adding extra tracks and allowing for speed increases — resulting in much better service today.

The **Halton Subdivision** is still owned by CN as their main freight line that links to their American operations, however in October 2025, the Ontario government and CN reached an [agreement in principle](https://news.ontario.ca/en/release/1006613/ontario-delivering-more-frequent-go-train-service-between-kitchener-and-toronto), which would allow Metrolinx to purchase 20 kilometers of land across this subdivision to build dedicated tracks. This will open the corridor up for better service, but until then GO will need to continue to negotiate  with CN to allow passenger and freight trains to co-exist on the line, allowing  for two-way, all-day GO service from Mount Pleasant to Union Station.

The **Guelph Subdivision** between Kitchener and Georgetown was under CN’s ownership and later leased to a small freight operator, which limited any upgrades for passenger service by GO Transit. The track actively degraded when the shortline leased the track. [In 2014, Metrolinx bought the corridor,](https://www.trains.com/trn/news-reviews/news-wire/24-ontario-shortlines-leased-trackage-returning-to-cn-this-year/) but the freight lease did not expire until 2018\. This delayed key work like passing tracks and higher-speed sections. Metrolinx was unable to perform any corridor improvements during this time. But 2018 was 7 years ago, what’s the hold up?
...
1. East of Mount Pleasant station it has just one passenger track available for GO to use, meaning that only one train can travel going in either direction on this line at a time.  
2. GO trains must cross over busy freight tracks at Georgetown to continue through, often competing and conflicting with freight, which limits train frequency.

**The Georgetown Problem**

[Metrolinx has expropriated land in Halton Hills](https://www.cbc.ca/news/canada/kitchener-waterloo/land-expropriation-metrolinx-two-way-all-day-go-kitchener-1.7269827), west of Mount Pleasant GO, to build a flyover that will let GO passenger trains cross CN’s freight tracks without conflict. The project also includes two new mainline tracks and the relocation of CN’s freight tracks, creating separate corridors for passenger and freight trains. This will make service faster, more reliable and [allow Metrolinx to run much more service](https://assets.metrolinx.com/image/upload/v1663237565/Documents/Metrolinx/2021-03-04-Kitchener-Mid-Term-Service-Expansion-PDBC-FINAL.pdf) than hourly two-way, all-day GO if demand requires.
...
![Diagram showing increased frequency and decreased running time for the route since 2012](images/go-scheduling-diagram.png)
...
During the COVID-19 pandemic, many older buses were retired before replacements had arrived. Factors such frequent bus substitutions on several GO rail lines for track work and a rapid ridership recovery post pandemic has meant that GO Transit’s bus fleet is now stretched thin. They’ve recently [ordered 97 new coaches](https://bus-news.com/metrolinx-orders-97-additional-coaches-for-greater-toronto-and-hamilton/) to help meet demand, on top of a previous purchase of [80 buses earlier this year](https://bus-news.com/canada-metrolinx-orders-commuter-coaches-from-mci/).
...
![Second deck of busy GO bus with a standee in the aisle](images/busy-go-bus.png)
...
Although this part of the corridor (the busiest part of the Kitchener line) already has 3-4 tracks, there needs to be an additional track to accommodate the Kitchener local, express and UP express trains. This is why GO completed the [401-409 twin tunnel project](https://www.metrolinx.com/en/discover/401-409-tunnel-project-hits-substantial-completion) in 2021 to accommodate two additional tracks up to Bramalea station. However the current Etobicoke station platform is blocking the Eastern entrance to the tunnels. GO is working with Woodbine Racetrack to construct a new [Woodbine station](https://www.metrolinx.com/en/news/construction-underway-on-new-woodbine-go-station%20) to act as a transfer station between GO, UP express and the Finch West LRT in the future. Once this station is completed in the next 2 years or so, Etobicoke North can be demolished and rail can be put in the tunnels. 
...
You can find your MPP by searching your address on the [*Find an MPP* tool](https://www.ola.org/en/members/current) on the Ontario Legislature’s website, then call or email their office to share your support.
